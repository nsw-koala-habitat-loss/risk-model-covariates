...
# load profit data
AgriProfit <- rast(file.path(INPUT_DIR, "Agricultural profit map for Australia for 2010-2011/pfe201011.tif")) %>% 
  project(Woody, thread = TRUE) %>% 
  crop(Woody, snap = "out", mask = TRUE)

AUS_AgriProfit <- rast(file.path(INPUT_DIR, "Agricultural profit map for Australia for 2010-2011/pfe201011.tif"))
